...
<html lang="en">
  <head>
    ...
    <title>WhatToExpect Threshold Scenario 4</title>
      ...
      <div class="starter-template" style="padding-top:70px">
        <div class="col-md-8 pull-left" style="padding-left:0px">
          ...
          <div style="height:450px; padding-top:10px;">
            <p style="font-size:18px; color:#F59C12;">You’ve had a crazy couple of weeks juggling work, your baby and a nagging mother-in-law!</p>
              <div style="display:block; padding-top: 120px;"><input type="radio" name="project" value="no"><b><i>&nbsp; I need to hit the parlor and just get pampered this weekend </i></b></div>
              
              <div style="display:block; padding-top: 40px;"><input type="radio" name="project" value="yes"><b><i>&nbsp; I’ll reach out to a friend to babysit and try to catch up on some sleep </i></b></div>
          </div>
          
          <div class="lead" style="padding-left:380px">
            <a href="#"><span id="next-btn" class="btn btn-group-sm btn-default">Next</span></a>
          </div>
        </div>
