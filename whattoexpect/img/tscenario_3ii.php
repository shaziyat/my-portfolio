...
<html lang="en">
  <head>
    ...
    <title>WhatToExpect Threshold Scenario 3</title>
    ...
    <script>
      function imgChange15( img ) {
        document.withbaby.src = img;
      }
      function imgChange16( img ) {
        document.withladies.src = img;
      }
    </script>
      ...
      <div class="starter-template" style="padding-top:70px">
        <div class="col-md-8 pull-left" style="padding-left:0px">
          ...
          <div style="height:450px; padding-top:10px;">
            <p style="font-size:18px; color:#F59C12;">It’s been a tough at the office. How do you want to spend the rest of your evening?</p>
            <div align="center" class="col-md-6 pull left" style="padding-top:80px;">
              <img id="withbaby" name="withbaby" src="img/withbaby.png" height=167px width=250px onmouseover="imgChange15('img/withbaby2.png')" onmouseout="imgChange15('img/withbaby.png')" style="display: block"></img>
              <br/>
              <input type="radio" name="evening" value="withbaby"><b><i>&nbsp; I should head home and spend time with my baby </i></b>
            </div>
            <div align="center" class="col-md-6 pull left" style="display: inline-block; padding-top:80px;">
              <img id="withladies" name="withladies" src="img/withladies.png" height=167px width=250px onmouseover="imgChange16('img/withladies2.png')" onmouseout="imgChange16('img/withladies.png')" style="display: block"></img>
              <br/>
              <input type="radio" name="evening" value="withladies"><b><i>&nbsp; I need a night with my ladies to de-stress </i></b>
            </div>
          </div>
          
          <div class="lead" style="padding-left:380px">
            <a href="tscenario_4ii.php"><span id="next-btn" class="btn btn-group-sm btn-default">Next</span></a>
          </div>
        </div>
