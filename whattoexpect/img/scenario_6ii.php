...
<html lang="en">
  <head>
    ...
    <title>WhatToExpect Scenario 6</title>
      ...
      <div class="starter-template" style="padding-top:70px">
        <div class="col-md-8 pull-left" style="padding-left:0px">
          ...
          <div style="height:450px; padding-top:10px;">
            <p style="font-size:18px; color:#F59C12;">Breastfeeding is a great way to burn up to 500 calories a day but it takes a lot of time and planning at work. What do you want to do?</p>            
              <div style="display:block; padding-top: 100px;"><input type="radio" name="feeding" value="1"><b><i>&nbsp; Let’s do it! My baby will be healthier and it’s so much better than extra sweat sessions at the gym </i></b></div>
              
              <div style="display:block; padding-top: 40px;"><input type="radio" name="feeding" value="2"><b><i>&nbsp; I’ll need more calorie intake with breastfeeding than if I were formula feeding so I’d rather work out </i></b></div>
              
              <div style="display:block; padding-top: 40px;"><input type="radio" name="feeding" value="3"><b><i>&nbsp; I’ll go with mixed feeding; it’ll take more planning but its the perfect workaround </i></b></div>
            
          </div>
          
          <div class="lead" style="padding-left:380px">
            <a href="tscenario_1ii.php"><span id="next-btn" class="btn btn-group-sm btn-default">Next</span></a>
          </div>
        </div>
        ...
        <div class="col-md-4 pull-right" style="padding-left:20px; padding-top:10px; background-color: #E4E4E4">
          ...
          <img src=img/calendar.png width=25px height=25px style="display: inline-block;"> </img> &nbsp; <h5 style="display: inline-block;">Timeline [in months]</h5>
            <div class="progress" align="center" style="margin-bottom:0px;">
              <div class="progress-bar progress-bar-warning progress-bar-striped active" id="timeline" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
              </div>
            </div>
